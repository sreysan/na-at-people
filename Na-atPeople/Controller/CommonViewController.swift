...
class CommonViewController: UIViewController , HeaderProtocol {
	...
	func gotToLoginViewControllerFromSubFlow() {
		(self.tabBarController as! TabBarViewController).loginViewController?.navigationController?.popToRootViewController(animated: true)
	}
